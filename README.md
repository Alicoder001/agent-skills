...
[![Skills: 35](https://img.shields.io/badge/skills-35-green)](.)
...
- `infra`: monorepo
- `perf`: javascript
- `agent`: reasoning, planning, memory, tools, collaboration, senior, workflow, notion-ops, find-skills, project-init, skill-update
